...
const Candidate = (item) => {
  ...
  return (
    <div className='p-3 lg:p-5 rounded-[12px] border border-solid border-[#3D52A0] mb-5 cursor-pointer'>
        ...
        <h4 className='text-[12px] text-gray-500 leading-7 lg:text-[18px] lg:leading-8 text-headingColor'>Party Name</h4>
            <p className='text-[14px] leading-6 lg:text-[16px] lg:leading-7 font-[400] text-gray-500'>Description</p>
        </div>
    </div>
  )
}
